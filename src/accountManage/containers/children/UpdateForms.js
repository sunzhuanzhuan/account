...
export class CooperateInfoForm extends Component {
	...
	render() {
		const { form, params } = this.props
		const { actions: { updateAccountCooperation } } = params
		return <WrapPanelForm header='合作信息' navId='cooperationInfos' onSave={this.onSave} action={updateAccountCooperation}>
