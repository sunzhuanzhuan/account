  ...
  return <FormItem {...formItemLayout} label='粉丝截图'>
    <div className='clearfix'>
      {getFieldDecorator('extend.followerCountScreenshotUrl', {
        ...
        <WBYUploadFile tok={actions.getNewToken} uploadUrl='/api/common-file/file/v1/uploadPubBucket' disabled={disabled} accept={'.bmp, .gif, image/jpeg'} uploadText={'点击上传'} size={5} showUploadList={{
